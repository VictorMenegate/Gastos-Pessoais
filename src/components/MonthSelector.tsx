...
export default function MonthSelector({ value, onChange, compact }: Props) {
  ...
  return (
    <div className="flex items-center gap-0.5 rounded-xl px-1 py-1 bg-surface-input border border-surface-border">
      <button
      ...
      <button
        onClick={goToToday}
        className="text-fg font-bold min-w-[110px] text-center capitalize text-xs rounded-lg px-2 py-1.5 hover:bg-surface-hover transition-colors tracking-wide"
